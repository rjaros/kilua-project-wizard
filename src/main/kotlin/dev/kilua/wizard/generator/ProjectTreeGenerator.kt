...
class ProjectTreeGenerator {
    ...
    private fun generateAttributes(
        ...
        return mapOf(
            ...
            "tailwindcss_version" to versionData.tailwindcss,
            "vite_kotlin_version" to versionData.viteKotlin,
            "ktml_version" to versionData.ktml,
            ...
            "tailwindcss_included" to modules.contains("kilua-tailwindcss"),
            "i18n_included" to modules.contains("kilua-i18n"),
            "ktml_included" to modules.contains("kilua-ktml"),
